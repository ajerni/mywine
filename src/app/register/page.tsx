      ...
      <div className="w-full max-w-md space-y-1">
        ...
        <div className="bg-black py-4 px-4 shadow sm:rounded-lg sm:px-8 border border-red-500">
          ...
          <div className="mt-6">
            ...
            <div className="mt-3">
              <Link href="/login" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-black bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 touch-action-manipulation">
                Log in
              </Link>
            </div>
          </div>
