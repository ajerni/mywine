...
export default function AddEditForm({ isAdding, wine, onSave, onClose }: AddEditFormProps) {
  ...
  return (
    <div className="fixed inset-x-0 top-[4.5rem] bottom-0 flex flex-col bg-background ios-form-container">
      {/* Header - Updated with iOS-specific classes */}
      <div className="ios-form-header flex-none bg-background border-b px-4 py-3 flex items-center justify-between">
      ...
      {/* Main Form Container - Updated with iOS-specific classes */}
