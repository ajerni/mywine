...
export default function AddEditForm({ isAdding, wine, onSave, onClose }: AddEditFormProps) {
  ...
  return (
    <div className="fixed inset-x-0 top-[3.5rem] bottom-0 flex flex-col bg-background ios-form-container">
      {/* Header */}
      <div className="sticky top-0 z-[100] flex-none bg-background border-b px-4 py-3 flex items-center justify-between ios-form-header">
      ...
      {/* Main Form Container */}
      <div className="flex-1 overflow-y-auto z-[90] ios-form-scroll">
        <div className="w-full px-4 sm:px-6 lg:px-8 py-4 ios-form-content">
